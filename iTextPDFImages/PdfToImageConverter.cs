...
namespace itext.pdfimage
{
    public class PdfToImageConverter
    {
        ...
        public IEnumerable<Bitmap> ConvertToImages(string filename)
        {
           // IEnumerable<Bitmap> images = new IEnumerable<Bitmap>();
            ...
            //{
            //    //bitmap.Save(System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), $"wave-{DateTime.Now.Ticks}.png"), ImageFormat.Png);
            //    images.Add(bitmap);
            //    bitmap.Dispose();
            //}
            ...
            //bitmap1.Save(System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), $"wave-page1-{DateTime.Now.Ticks}.png"), ImageFormat.Png);
            //bitmap1.Dispose();
